...
GlobalFonts.registerFromPath(
  `${__dirname}/../../assets/fonts/Poppins/Poppins-Regular.ttf`,
  "Poppins",
);
GlobalFonts.registerFromPath(
...
GlobalFonts.registerFromPath(
  `${__dirname}/../../assets/fonts/Manrope/Manrope-Regular.ttf`,
  "Manrope",
);
GlobalFonts.registerFromPath(
  `${__dirname}/../../assets/fonts/Manrope/Manrope-Bold.ttf`,
  "Manrope Bold",
);
GlobalFonts.registerFromPath(
  `${__dirname}/../../assets/fonts/Others/AbyssinicaSIL-Regular.ttf`,
  "Abyss",
);
GlobalFonts.registerFromPath(
  `${__dirname}/../../assets/fonts/Others/ChirpRegular.ttf`,
  "Chirp",
);
